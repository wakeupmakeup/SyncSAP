		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "테이블 예제 만들기",
									"targetURL": "#sync04dexercise03-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync04dexercise03-display": {
								"semanticObject": "sync04dexercise03",
								"action": "display",
								"description": "테이블, 계산기 예제입니다. ",
								"title": "테이블 예제 만들기",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync04d.exercise03",
									"url": sap.ui.require.toUrl("sync04d/exercise03")
								}
							}
						}
					}
