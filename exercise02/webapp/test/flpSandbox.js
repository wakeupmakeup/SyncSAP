		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "계산기 프로그램",
									"targetURL": "#syncd04exercise02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncd04exercise02-display": {
								"semanticObject": "syncd04exercise02",
								"action": "display",
								"description": "step11~20까지 배운 내용을 바탕으로 계산기를 만들자.",
								"title": "계산기 프로그램",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.d04.exercise02",
									"url": sap.ui.require.toUrl("sync/d04/exercise02")
								}
							}
						}
					}
